...
<Project Type="Project" LVVersion="26008000">
	...
	<Property Name="NI.Project.Description" Type="Str">This LabVIEW-based application is designed to streamline file management by automatically sorting large volumes of files (primarily images) into a structured directory hierarchy. By programmatically accessing the File Storage Information, the tool retrieves the exact creation date of each item.

The core logic iterates through a source directory, parses the "Date Created" metadata, and dynamically generates a folder structure following a Year/Month format. If the destination folders do not exist, the application creates them on the fly before executing a secure move or copy operation. This project highlights the use of File I/O VIs, loops, and string manipulation in a G-programming environment.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="datearray_foldercreation_copyfiles_erasefiles.vi" Type="VI" URL="../subVI/datearray_foldercreation_copyfiles_erasefiles.vi"/>
		...
		<Item Name="folder_to_string_log_record.vi" Type="VI" URL="../subVI/folder_to_string_log_record.vi"/>
		<Item Name="comparing_files_before_erase.vi" Type="VI" URL="../subVI/comparing_files_before_erase.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Main Application" Type="EXE">
				...
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/Main_Organizer.vi</Property>
